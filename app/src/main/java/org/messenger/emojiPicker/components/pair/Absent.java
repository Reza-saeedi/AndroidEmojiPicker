package org.messenger.emojiPicker.components.pair;

import java.util.Collections;
import java.util.Set;

import static org.messenger.emojiPicker.components.pair.Preconditions.checkNotNull;

public class  Absent extends Optional<Object> {
